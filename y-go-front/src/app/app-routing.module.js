...
const detail_bar_component_1 = require(
  `./pages/bars/detail-bar/detail-bar.component`,
);
...
const detail_user_component_1 = require(
  `./pages/users/detail-user/detail-user.component`,
);
const routes = [
