...
AccueilNavComponent = __decorate([
    (0, core_1.Component)({
        ...
        standalone: true,
        imports: [common_1.NgIf, list_1.MatListModule, divider_1.MatDividerModule, button_1.MatButtonModule, router_1.RouterLinkActive, router_1.RouterLink, button_unit_horiz_component_1.ButtonUnitHorizComponent],
    })
], AccueilNavComponent);
