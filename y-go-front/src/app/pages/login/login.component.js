...
let LoginComponent = class LoginComponent {
    ...
    onSubmit(form) {
        ...
        this.http.post(url, userData).pipe((0, rxjs_1.catchError)(error => {
...
LoginComponent = __decorate([
    (0, core_1.Component)({
        ...
        standalone: true,
        imports: [form_field_1.MatFormFieldModule, input_1.MatInputModule, icon_1.MatIconModule, button_1.MatButtonModule, forms_1.FormsModule],
    })
], LoginComponent);
