    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const user = this.usersRepository.create({
          ...
          role:
            (_a = createUserDto.role) !== null && _a !== void 0
              ? _a
              : user_roles_enum_1.UserRoleEnum.Utilisateur,
        });
        ...
        if (
          error instanceof errors_1.EmailAlreadyExistsException ||
  ...
  login(loginDto) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const passwordMatch = yield bcrypt.compare(
          loginDto.password,
          user.password,
        );
        if (!passwordMatch) {
