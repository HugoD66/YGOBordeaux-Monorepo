...
let Bar = exports.Bar = (() => {
    ...
    var Bar = _classThis = class {
        constructor() {
            ...
            this.pictureList = __runInitializers(this, _pictureList_initializers, void 0);
            ...
            this.userBarRatings = __runInitializers(this, _userBarRatings_initializers, void 0);
        }
    };
    ...
    (() => {
        ...
        _note_decorators = [(0, typeorm_1.Column)({ type: 'float', nullable: true })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)()];
        _updatedAt_decorators = [(0, typeorm_1.UpdateDateColumn)()];
        _pictureList_decorators = [(0, typeorm_1.OneToOne)(() => picture_list_entity_1.PictureList, pictureList => pictureList.bar, {
                cascade: ['insert', 'update', 'remove'],
                onDelete: 'CASCADE',
            }), (0, typeorm_1.JoinColumn)()];
        _geo_decorators = [(0, typeorm_1.OneToOne)(() => geo_entity_1.Geo, geo => geo.bar, {
                cascade: ['insert', 'update', 'remove'],
                onDelete: 'CASCADE',
            }), (0, typeorm_1.JoinColumn)()];
        _createdBy_decorators = [(0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.createBars), (0, typeorm_1.JoinColumn)({ name: 'createdById' })];
        _userBarRatings_decorators = [(0, typeorm_1.OneToMany)(() => user_bar_rating_entity_1.UserBarRating, userBarRating => userBarRating.bar)];
        ...
        __esDecorate(null, null, _adresse_decorators, { kind: "field", name: "adresse", static: false, private: false, access: { has: obj => "adresse" in obj, get: obj => obj.adresse, set: (obj, value) => { obj.adresse = value; } } }, _adresse_initializers, _instanceExtraInitializers);
        ...
        __esDecorate(null, null, _telephone_decorators, { kind: "field", name: "telephone", static: false, private: false, access: { has: obj => "telephone" in obj, get: obj => obj.telephone, set: (obj, value) => { obj.telephone = value; } } }, _telephone_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _note_decorators, { kind: "field", name: "note", static: false, private: false, access: { has: obj => "note" in obj, get: obj => obj.note, set: (obj, value) => { obj.note = value; } } }, _note_initializers, _instanceExtraInitializers);
        ...
        __esDecorate(null, null, _pictureList_decorators, { kind: "field", name: "pictureList", static: false, private: false, access: { has: obj => "pictureList" in obj, get: obj => obj.pictureList, set: (obj, value) => { obj.pictureList = value; } } }, _pictureList_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _geo_decorators, { kind: "field", name: "geo", static: false, private: false, access: { has: obj => "geo" in obj, get: obj => obj.geo, set: (obj, value) => { obj.geo = value; } } }, _geo_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _createdBy_decorators, { kind: "field", name: "createdBy", static: false, private: false, access: { has: obj => "createdBy" in obj, get: obj => obj.createdBy, set: (obj, value) => { obj.createdBy = value; } } }, _createdBy_initializers, _instanceExtraInitializers);
        __esDecorate(null, null, _userBarRatings_decorators, { kind: "field", name: "userBarRatings", static: false, private: false, access: { has: obj => "userBarRatings" in obj, get: obj => obj.userBarRatings, set: (obj, value) => { obj.userBarRatings = value; } } }, _userBarRatings_initializers, _instanceExtraInitializers);
