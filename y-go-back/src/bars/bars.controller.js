...
__decorate([(0, public_decorator_1.Public)(), (0, common_1.Get)()], BarsController.prototype, `findAll`, null)
__decorate(
  [(0, common_1.Patch)(`:id`), __param(0, (0, common_1.Param)(`id`)), __param(1, (0, common_1.Body)())],
  BarsController.prototype,
  `update`,
  null
)
