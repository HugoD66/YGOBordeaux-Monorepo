...
let UserBarRatingController =
  (exports.UserBarRatingController = class UserBarRatingController {
    constructor(userBarRatingService) {
      this.userBarRatingService = userBarRatingService;
    }
    async create(createUserBarRatingDto) {
      const rate = await this.userBarRatingService.create(
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      create_user_bar_rating_dto_1.CreateUserBarRatingDto,
    ]),
    __metadata('design:returntype', Promise),
  ],
  UserBarRatingController.prototype,
  'create',
  null,
);
__decorate(
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      String,
      update_user_bar_rating_dto_1.UpdateUserBarRatingDto,
    ]),
    __metadata('design:returntype', Promise),
  ],
  UserBarRatingController.prototype,
