...
export declare class PictureListService {
    ...
    create(createPictureListDto: CreatePictureListDto): Promise<ResponsePictureListDto>;
    findOne(id: string): Promise<ResponsePictureListDto>;
    findAll(): Promise<ResponsePictureListDto[]>;
    update(id: string, updatePictureListDto: Partial<UpdatePictureListDto>): Promise<ResponsePictureListDto>;
